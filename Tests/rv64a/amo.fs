...
[<Theory>]
[<InlineData(0xffffffff80000000L, 0xffffffff80000000L, 0L, 0xffffffffffffffffL)>]
let ``AMO.MIN`` (a4, a5, a6, a7) =
    let instrSet = [|
            0x80000537
            0x80000593
            0x00001697
...
[<Theory>]
[<InlineData(0xffffffff80000000L, 0xffffffff80000000L, 0L, 0L)>]
let ``AMO.MINU`` (a4, a5, a6, a7) =
    let instrSet = [|
            0x80000537
            0x80000593
            0x00001697
